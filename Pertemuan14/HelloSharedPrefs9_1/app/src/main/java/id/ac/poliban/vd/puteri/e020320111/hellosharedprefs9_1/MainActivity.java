package id.ac.poliban.vd.puteri.e020320111.hellosharedprefs9_1;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String sharedPrefFile = "id.ac.poliban.vd.puteri.e020320111.hellosharedprefs9_1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("HelloSharedPrefs_puteri");
