package id.ac.poliban.mi.vd.e020320111.notificationschedulerchallenge;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Puteri - Notification Scheduler Challenge");
    ...
    public void scheduleJob(View view) {
        ...
        ComponentName componentName = new ComponentName(getPackageName(),
                id.ac.poliban.mi.vd.e020320111.notificationschedulerchallenge.SleeperJobScheduler.class.getName());
